...
## Current Version
  ...
  For versions of ArchivesSpace **before** v2.2.2:  [v1.7.5](https://github.com/harvard-library/aspace-import-excel/releases/tag/v1.7.5)  **Note:** This version does *not* support the creation of Digital Objects to be associated with already-created Archival Objects.

  For ArchivesSpace **v2.2.2 and higher**: [v2.1.1](https://github.com/harvard-library/aspace-import-excel/releases/tag/v2.1.1)
